...
var _api_1 = __importDefault(require("./api/_api"));
var _index_1 = __importDefault(require("./db/_index"));
var _error_1 = __importDefault(require("./error/_error"));
var _index_2 = __importDefault(require("./lib/_index"));
var _models_1 = __importDefault(require("./models/_models"));
var _net_1 = __importDefault(require("./net/_net"));
var shared = {
    db: _index_1.default,
    lib: _index_2.default,
    error: _error_1.default,
    models: _models_1.default,
    api: _api_1.default,
    net: _net_1.default,
    init: function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _index_1.default.pg.init()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    cleanup: function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _index_1.default.pg.tearDown()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    requireTesting: function () {
        if (process.env.NODE_ENV != 'test') {
            throw 'NODE_ENV must be test';
        }
        shared.test = require('./test/_test');
        /*
    ...
    initDynamo: function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                /*
                ...
                */
                return [4 /*yield*/, _index_1.default.dynamo.init()];
                case 1:
                    /*
                      Avoiding puting this into the general init -
                      at least until I set up readonly credentials,
