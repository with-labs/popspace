...
module.exports = {
  ...
  sendRoomClaimEmail: async (toEmail, roomName, url) => {
    ...
    const html = `<div style="padding: 0px !important; margin: 0px !important; background: white;">
      <div style="padding:40px; margin:0px; background: white; max-width: 520px; margin: 0px auto; text-align: center;">
        <a href=${url} target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" class="x_logo-img" style="border:none; display:block; height:34px; text-decoration:none; margin-bottom: 10px;">
        ...
        <div style="padding:40px; margin:0px; background: #FFF8F0; margin: 0px auto; text-align: left;">
          <h1 style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif!important; font-size:24px; line-height:1.6!important; color:#333; margin:0px!important; padding-top:20px; padding-bottom:20px;">Your room is ready!</h1>
          <p style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif !important; font-size:16px; line-height:1.6 !important; color: #333; margin: 0px 0px 10px 0px !important">
            At With, we are hard at work creating an experience for your team to stay in sync and feel more connected.
          </p>
          <p style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif !important; font-size:16px; line-height:1.6 !important; color: #333; margin: 0px 0px 10px 0px !important">
            You need to associate your email address to your room, so you can eventually create more rooms, rename rooms, delete rooms, and invite other members of your team, in a more convenient and secure way.
          </p>
          <p style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif !important; font-size:16px; line-height:1.6 !important; color: #333; margin: 0px 0px 10px 0px !important">
            Use this link to associate your room <b>${roomName}</b> with your account <b>${toEmail}</b>.
          </p>
          ...
          <div style="border-radius:6px; margin-top:10px!important; padding: 12px; background: #ffffff; overflow-wrap: break-word; word-wrap: break-word; -ms-word-break: break-all; word-break: break-word; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif!important; font-size:13px; line-height:1.6!important; color:#333;">${url}</div>
        </div>
