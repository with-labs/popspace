 ...
 */
export const AudioIndicator: React.FC<IAudioIndicatorProps> = ({ isActive, isPaused, className }) => {
    ...
    if (isActive) {
      if (isPaused) {
        ...
        const loop = (timestamp: DOMHighResTimeStamp) => {
          ...
          const val1 = (Math.sin(elapsed - Math.PI / 3) + 1) * 6;
          const val2 = (Math.sin(elapsed + Math.PI / 2) + 1) * 8;
          const val3 = (Math.sin(elapsed + Math.PI / 6) + 1) * 6;
  ...
  }, [isActive, isPaused, setBar1, setBar2, setBar3]);
